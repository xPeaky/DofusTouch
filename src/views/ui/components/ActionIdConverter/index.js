var data = {
	...
	ACTION_SEQUENCE_START: 83,      // 'S',
	ACTION_SEQUENCE_END: 70,        // 'F',
	...
	//ACTION_CHARACTER_CHANGE_WAIT_TIME: 13,
	...
	ACTION_CARRY_CHARACTER: 50,           // porter un joueur
	ACTION_THROW_CARRIED_CHARACTER: 51,   // jeter un joueur
	ACTION_NO_MORE_CARRIED: 52,           // descendre sans anim

	// glisser sur un terrain (2 params : rp/fight/both (1/2/3), proba /1000 )
	//ACTION_CHARACTER_SLIDE: 59,

	// @Deprecated
	// actionner un levier (action ne sert à rien, c't'un skill, mais fallait un n° d'action/skill. )
	// ACTION_CHARACTER_USE_SWITCH: 60,
	...
	ACTION_CHARACTER_CHANGE_COLOR: 333,   // Paramètre mis à jour pour dofus 2 via moulinette sur la base
	ACTION_CHARACTER_CHANGE_LOOK: 149,    // Remplace entièrement par une autre apparence
	ACTION_CHARACTER_ADD_APPEARANCE: 335, //Modifie une partie de l'apparence d'un personnage.
	...
	// ACTION_CHARACTER_MOVEMENT_POINTS_LOST_REFLECTOR: 167,
	...
	// ACTION_CHARACTER_INVENTORY_REMOVE_ITEM_ON_RP_MAP_ALIGNMENT: 234, // TODO
	// ACTION_CHARACTER_LIFE_POINTS_WIN_ON_RP_MAP_ALIGNMENT: 235,       // TODO
	...
	ACTION_USE_ELEMENT_ACTIONS: 651, // actions 'sous cellule' du skill par défaut
	ACTION_SET_STATED_ELEMENT_STATE: 652, // modification d'un élément d'état
	ACTION_RESET_STATED_ELEMENT: 653, // reset d'un élément d'état
	ACTION_HOUSE_LEAVE: 654, // sortir de la maison courante
	...
	// shushu de rushu
	// Deux effets non utilisé dans le code, mais présent dans les effets des objets en base
	...
	// non utilisé dans le code, mais présent dans les effets des objets en base
	...
	ACTION_FIGHT_TURN_FINISHED: 899, // dispatch de la fin de tour
	...
	// ACTION_FIGHT_CHALLENGE_IMPOSSIBLE: 904,   // inutilisé : remplacé par des 903

	ACTION_FIGHT_CHALLENGE_AGAINST_MONSTER: 905,

	ACTION_FIGHT_AGGRESSION: 906,
	// ACTION_FIGHT_AGGRESSION_JOIN: 907,
	// ACTION_FIGHT_AGGRESSION_IMPOSSIBLE: 908,
	...
	// Seulement en effet d'objet, pas dans le code
	//    ACTION_FARM_BOOST_SERENITY: 930,
	//    ACTION_FARM_UNBOOST_SERENITY: 931,
	//    ACTION_FARM_BOOST_STAMINA: 932,
	//    ACTION_FARM_UNBOOST_STAMINA: 933,
	//    ACTION_FARM_BOOST_LOVE: 934,
	//    ACTION_FARM_UNBOOST_LOVE: 935,
	//    ACTION_FARM_BOOST_MATURITY: 936,
	//    ACTION_FARM_UNBOOST_MATURITY: 937,
	...
	// Not in the original source file, got it from ItemWrapper.as
	...
	// Bonus/Malus sur toutes les resistances
	ACTION_BOOST_GLOBAL_RESISTS_BONUS: 1076,
	ACTION_BOOST_GLOBAL_RESISTS_MALUS: 1077
};

var actionInfo = {};
actionInfo[data.ACTION_CHARACTER_BOOST_LIFE_POINTS] = ['lifePoints', true];
actionInfo[data.ACTION_CHARACTER_MOVEMENT_POINTS_LOST] = ['movementPoints', false];
actionInfo[data.ACTION_CHARACTER_BOOST_MOVEMENT_POINTS] = ['movementPoints', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_MOVEMENT_POINTS] = ['movementPoints', false];
actionInfo[data.ACTION_CHARACTER_ACTION_POINTS_LOST] = ['actionPoints', false];
actionInfo[data.ACTION_CHARACTER_BOOST_ACTION_POINTS] = ['actionPoints', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_ACTION_POINTS] = ['actionPoints', false];
actionInfo[data.ACTION_CHARACTER_DEBOOST_DAMAGES] = ['allDamagesBonus', false];
actionInfo[data.ACTION_CHARACTER_BOOST_DAMAGES] = ['allDamagesBonus', true];
actionInfo[data.ACTION_CHARACTER_BOOST_PHYSICAL_DAMAGES] = ['physicalDamagesBonus', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_DAMAGES_PERCENT] = ['damagesBonusPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_DAMAGES_PERCENT] = ['damagesBonusPercent', true];
actionInfo[data.ACTION_CHARACTER_BOOST_MAXIMUM_SUMMONED_CREATURES] = ['summonableCreaturesBoost', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_EARTH_ELEMENT_PERCENT] = ['earthElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_EARTH_ELEMENT_PERCENT] = ['earthElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_WATER_ELEMENT_PERCENT] = ['waterElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_WATER_ELEMENT_PERCENT] = ['waterElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_AIR_ELEMENT_PERCENT] = ['airElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_AIR_ELEMENT_PERCENT] = ['airElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_FIRE_ELEMENT_PERCENT] = ['fireElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_FIRE_ELEMENT_PERCENT] = ['fireElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_NEUTRAL_ELEMENT_PERCENT] = ['neutralElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_NEUTRAL_ELEMENT_PERCENT] = ['neutralElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_EARTH_ELEMENT_PVP_PERCENT] = ['pvpEarthElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_EARTH_ELEMENT_PVP_PERCENT] = ['pvpEarthElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_WATER_ELEMENT_PVP_PERCENT] = ['pvpWaterElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_WATER_ELEMENT_PVP_PERCENT] = ['pvpWaterElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_AIR_ELEMENT_PVP_PERCENT] = ['pvpAirElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_AIR_ELEMENT_PVP_PERCENT] = ['pvpAirElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_FIRE_ELEMENT_PVP_PERCENT] = ['pvpFireElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_FIRE_ELEMENT_PVP_PERCENT] = ['pvpFireElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_NEUTRAL_ELEMENT_PVP_PERCENT] = ['pvpNeutralElementResistPercent', false];
actionInfo[data.ACTION_CHARACTER_BOOST_NEUTRAL_ELEMENT_PVP_PERCENT] = ['pvpNeutralElementResistPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_RANGE] = ['range', false];
actionInfo[data.ACTION_CHARACTER_BOOST_RANGE] = ['range', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_STRENGTH] = ['strength', false];
actionInfo[data.ACTION_CHARACTER_BOOST_STRENGTH] = ['strength', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_AGILITY] = ['agility', false];
actionInfo[data.ACTION_CHARACTER_BOOST_AGILITY] = ['agility', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_CHANCE] = ['chance', false];
actionInfo[data.ACTION_CHARACTER_BOOST_CHANCE] = ['chance', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_WISDOM] = ['wisdom', false];
actionInfo[data.ACTION_CHARACTER_BOOST_WISDOM] = ['wisdom', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_VITALITY] = ['vitality', false];
actionInfo[data.ACTION_CHARACTER_BOOST_VITALITY] = ['vitality', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_INTELLIGENCE] = ['intelligence', false];
actionInfo[data.ACTION_CHARACTER_BOOST_INTELLIGENCE] = ['intelligence', true];
actionInfo[data.ACTION_CHARACTER_BOOST_TRAP] = ['trapBonus', true];
actionInfo[data.ACTION_CHARACTER_BOOST_TRAP_PERCENT] = ['trapBonusPercent', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_EARTH_ELEMENT_RESIST] = ['earthElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_EARTH_ELEMENT_RESIST] = ['earthElementReduction', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_WATER_ELEMENT_RESIST] = ['waterElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_WATER_ELEMENT_RESIST] = ['waterElementReduction', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_AIR_ELEMENT_RESIST] = ['airElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_AIR_ELEMENT_RESIST] = ['airElementReduction', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_FIRE_ELEMENT_RESIST] = ['fireElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_FIRE_ELEMENT_RESIST] = ['fireElementReduction', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_NEUTRAL_ELEMENT_RESIST] = ['neutralElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_NEUTRAL_ELEMENT_RESIST] = ['neutralElementReduction', true];
// actionInfo[data.ACTION_CHARACTER_DEBOOST_EARTH_ELEMENT_PVP_RESIST] = ['pvpEarthElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_EARTH_ELEMENT_PVP_RESIST] = ['pvpEarthElementReduction', true];
// actionInfo[data.ACTION_CHARACTER_DEBOOST_WATER_ELEMENT_PVP_RESIST] = ['pvpWaterElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_WATER_ELEMENT_PVP_RESIST] = ['pvpWaterElementReduction', true];
// actionInfo[data.ACTION_CHARACTER_DEBOOST_AIR_ELEMENT_PVP_RESIST] = ['pvpAirElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_AIR_ELEMENT_PVP_RESIST] = ['pvpAirElementReduction', true];
// actionInfo[data.ACTION_CHARACTER_DEBOOST_FIRE_ELEMENT_PVP_RESIST] = ['pvpFireElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_FIRE_ELEMENT_PVP_RESIST] = ['pvpFireElementReduction', true];
// actionInfo[data.ACTION_CHARACTER_DEBOOST_NEUTRAL_ELEMENT_PVP_RESIST] = ['pvpNeutralElementReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_NEUTRAL_ELEMENT_PVP_RESIST] = ['pvpNeutralElementReduction', true];
actionInfo[data.ACTION_CHARACTER_BOOST_CRITICAL_MISS] = ['criticalMiss', true];
actionInfo[data.ACTION_CHARACTER_BOOST_CRITICAL_HIT] = ['criticalHit', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_CRITICAL_HIT] = ['criticalHit', false];
actionInfo[data.ACTION_CHARACTER_BOOST_INITIATIVE] = ['initiative', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_INITIATIVE] = ['initiative', false];
actionInfo[data.ACTION_CHARACTER_BOOST_MAGIC_FIND] = ['prospecting', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_MAGIC_FIND] = ['prospecting', false];
actionInfo[data.ACTION_CHARACTER_BOOST_HEAL_BONUS] = ['healBonus', true];
actionInfo[data.ACTION_CHARACTER_BOOST_SHIELD_BASED_ON_CASTER_LIFE] = ['shieldPoints', true];
actionInfo[data.ACTION_CHARACTER_BOOST_SHIELD] = ['shieldPoints', true];
actionInfo[data.ACTION_CHARACTER_LIFE_POINTS_MALUS] = ['lifePointsMalus', false];
actionInfo[data.ACTION_CHARACTER_LIFE_POINTS_MALUS_PERCENT] = ['lifePointsMalus', false];
actionInfo[data.ACTION_CHARACTER_REFLECTOR_UNBOOSTED] = ['reflectorUnboosted', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_ACTION_POINTS_LOST_DODGE] = ['dodgePALostProbability', false];
actionInfo[data.ACTION_CHARACTER_BOOST_ACTION_POINTS_LOST_DODGE] = ['dodgePALostProbability', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_MOVEMENT_POINTS_LOST_DODGE] = ['dodgePMLostProbability', false];
actionInfo[data.ACTION_CHARACTER_BOOST_MOVEMENT_POINTS_LOST_DODGE] = ['dodgePMLostProbability', true];
actionInfo[data.ACTION_CHARACTER_BOOST_DAMAGES_FOR_ALL_GAME] = ['allDamagesBonus', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_MAXIMUM_WEIGHT] = ['maximumWeight', false];
actionInfo[data.ACTION_CHARACTER_BOOST_MAXIMUM_WEIGHT] = ['maximumWeight', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_PHYSICAL_REDUCTION] = ['physicalReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_PHYSICAL_REDUCTION] = ['physicalReduction', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_MAGICAL_REDUCTION] = ['magicalReduction', false];
actionInfo[data.ACTION_CHARACTER_BOOST_MAGICAL_REDUCTION] = ['magicalReduction', true];
actionInfo[data.ACTION_CHARACTER_BOOST_DODGE] = ['tackleEvade', true];
actionInfo[data.ACTION_CHARACTER_BOOST_TACKLE] = ['tackleBlock', true];
actionInfo[data.ACTION_CHARACTER_DEBOOST_DODGE] = ['tackleEvade', false];
actionInfo[data.ACTION_CHARACTER_DEBOOST_TACKLE] = ['tackleBlock', false];
actionInfo[data.ACTION_CHARACTER_BOOST_PERMANENT_DAMAGE_PERCENT] = ['permanentDamagePercent', true];
actionInfo[data.ACTION_BOOST_GLOBAL_RESISTS_BONUS] = ['globalResistPercentBonus', true];
actionInfo[data.ACTION_BOOST_GLOBAL_RESISTS_MALUS] = ['globalResistPercentMalus', true];

function getActionStatName(actionId) {
	return actionInfo[actionId] ? actionInfo[actionId][0] : null;
}

function getIsABoost(actionId) {
	return actionInfo[actionId] ? actionInfo[actionId][1] : false;
}

data.getActionStatName = getActionStatName;
data.getIsABoost = getIsABoost;
...
/*****************
 ** WEBPACK FOOTER
 ** ./src/views/ui/components/ActionIdConverter/index.js
 ** module id = 221
 ** module chunks = 0
 **/